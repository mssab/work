            ...
            Try
                ...
                If rd = 5 Then
                    If punkte1 < punkte2 Then
                        Response.Redirect("http://www.klick.gate-internet.de/Ergebnis.aspx?Gewinner=Spieler2")
                    End If
                    If punkte1 > punkte2 Then
                        Response.Redirect("http://www.klick.gate-internet.de/Ergebnis.aspx?Gewinner=Spieler1")
                    End If
                    If punkte1 = punkte2 Then
                        Response.Redirect("http://www.klick.gate-internet.de/Ergebnis.aspx?Gewinner=kein_gewinner")
                    End If
                End If
