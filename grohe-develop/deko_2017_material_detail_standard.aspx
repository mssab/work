<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2017_master_intern.master" AutoEventWireup="true" Debug="true" CodeFile="deko_2017_material_detail_standard.aspx.vb" Inherits="material_detail_standard" %>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                    ...
                    SelectCommand="SELECT [Banner Eurostyle], [Banner Livestyle], [Banner Essence], [Aufkleber Aquatunes], [Dekosäule Aquatunes], [Dekowürfel Nachhaltigkeit], [Dekowürfel Made in Germany], [Dekosäule Logo Standard], [Aufsteller 5 Jahre Garantie], [Aufkleber QR Code], [Aufkleber Logo], Badetuch FROM deko_2017_ausgabe_standard_nach_mitarbeiter WHERE (mitarbeiter = @mitarbeiter)">
                    <SelectParameters>
