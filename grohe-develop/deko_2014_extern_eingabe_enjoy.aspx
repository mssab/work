<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2014_master_extern.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="deko_2014_extern_eingabe_enjoy.aspx.vb" Inherits="deko_2014_extern_eingabe_enjoy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>Eingabe Grohe Standard Deko 2014</h1>
    <table>
        <tr>
            <td>Name:</td>
    ...
    <asp:Panel ID="deko_erfolgt" runat="server">
        ...
        <table style="width: 610px;">
            ...
            <tr>
                <td><b>Aufkleber Wasser</b></td>
                <td><asp:TextBox ID="wasser" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="wasser_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Kubistisch</b></td>
                <td><asp:TextBox ID="bannerkubistisch" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="bannerkubistisch_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Kind (neu)</b></td>
                <td><asp:TextBox ID="kindneu" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="kindneu_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Minta Touch</b></td>
                <td><asp:TextBox ID="bannermintatouch" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="bannermintatouch_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Mobile Icon Flower</b></td>
                <td><asp:TextBox ID="mobileiconflower" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="mobileiconflower_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Aufkleber Icon Flower</b></td>
                <td><asp:TextBox ID="aufklebericonflower" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="aufklebericonflower_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Deko Cube</b></td>
