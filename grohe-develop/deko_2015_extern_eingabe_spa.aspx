<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2015_master_extern.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="deko_2015_extern_eingabe_spa.aspx.vb" Inherits="deko_2015_extern_eingabe_spa" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>Eingabe Grohe SPA Deko 2015</h1>
    <table>
        <colgroup>
            <col width="150" />
            <col width="600" />
    ...
    <asp:Panel ID="deko_erfolgt" runat="server">
        ...
        <table style="width: 610px;">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="banner_essence" runat="server" CssClass="textbox"></asp:TextBox></td>
            ...
            <tr>
                <td><b>Aufkleber F-Digital Bluetooth</b></td>
            ...
            <tr>
                <td><b>Deko Säule SPA Logo</b></td>
                <td><asp:TextBox ID="deko_saeule_spa" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="deko_saeule_spa_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Body-Lotion</b></td>
                <td><asp:TextBox ID="body_lotion" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="body_lotion_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><b>Deko Steine "Hot Stones"</b></td>
