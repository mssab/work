...
Partial Class kunde_schaufenster_detail
    ...
    Protected Sub nav_back_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles nav_back.Click
        ...
        i = i - 1
        Response.Redirect("kunde_schaufenster_detail.aspx?id=" & i)
    End Sub
    ...
    Protected Sub nav_search_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles nav_search.Click
        Response.Redirect("kunde_schaufenster_liste.aspx")
    End Sub
    ...
    Protected Sub nav_fwd_PreRender(sender As Object, e As System.EventArgs) Handles nav_fwd.PreRender
        ...
        con.Open()
        Try
            command = "select max(id) from Stammdaten"
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        con.Open()
        Try
            command = "select count(id) from Stammdaten"
            Dim commando As New SqlCommand(command, con)
            zahl = commando.ExecuteScalar
        ...
        End Try
        stand.Text = "GP-ID &nbsp;&nbsp; " & Request.QueryString.Item("id") & "/" & zahl
        Try
        ...
        End Try
        Try
            command = "select name2 from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select GP_ID from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select plz + ' ' + ort as ort from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select telefon from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Try
            command = "select glh from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Try
            command = "select freigabe_bilder_intern from Stammdaten where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
