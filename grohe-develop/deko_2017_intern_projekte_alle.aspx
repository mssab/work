<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2017_master_intern.master" AutoEventWireup="false" CodeFile="deko_2017_intern_projekte_alle.aspx.vb" Inherits="deko_2017_intern_projekte_alle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:promotion %>" 
            ...
            SelectCommand="SELECT GP_ID, name, strasse, plz, ort, dekoration, datum, vl, gvl, glh, id FROM uebersicht_deko_2016">
    </asp:SqlDataSource>
</asp:Content>