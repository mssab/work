...
Partial Class deko_2017_extern_bilder_upload
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        con.Open()
        Try
            command = "select stammdaten_id from deko_2017_vakanz where id = " & stamm_id
    ...
    Protected Sub upload(ByVal upload As FileUpload, ByVal id As String, ByVal name As String)
        ...
        Else
            If upload.FileContent.Length > 1048576 Then
                filePath = Server.MapPath("deko_2017_upload_vakanz/" & id & "/" & name)
    ...
    Public Sub hochladen()
        IO.Directory.CreateDirectory(MapPath("deko_2017_upload_vakanz/" & Request.QueryString.Item("id").ToString))
