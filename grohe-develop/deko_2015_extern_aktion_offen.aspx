<%@ Page Title="" Language="VB" Debug="true" MasterPageFile="~/deko_2015_master_extern.master" AutoEventWireup="true" CodeFile="deko_2015_extern_aktion_offen.aspx.vb" Inherits="deko_2014_extern_aktion_offen" %>
...
<h1>Dekorationen mit offenen Berichten und Bildern</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT dbo.deko_2015_stammdaten.GP_ID, dbo.deko_2015_stammdaten.name, dbo.deko_2015_stammdaten.strasse, dbo.deko_2015_stammdaten.plz, dbo.deko_2015_stammdaten.ort, dbo.deko_2015_stammdaten.dekoration, dbo.promotion_login.vorname + ' ' + dbo.promotion_login.nachname AS Mitarbeiter, dbo.deko_2015_stammdaten.freigabe_bericht_extern, dbo.deko_2015_stammdaten.freigabe_bilder_extern, dbo.deko_2015_stammdaten.id FROM dbo.deko_2015_stammdaten INNER JOIN dbo.promotion_login ON dbo.deko_2015_stammdaten.mitarbeiter = dbo.promotion_login.id WHERE ((dbo.deko_2015_stammdaten.freigabe_bericht_extern = 'Nein') OR (dbo.deko_2015_stammdaten.freigabe_bilder_extern = 'Nein')) and mitarbeiter = @mitarbeiter">
        <SelectParameters>
