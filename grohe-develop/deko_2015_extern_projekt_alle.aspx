<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2015_master_extern.master" AutoEventWireup="true" CodeFile="deko_2015_extern_projekt_alle.aspx.vb" Inherits="deko_2015_extern_projekt_alle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [strasse], [plz], [ort], [telefon], [dekoration] FROM [deko_2015_stammdaten] WHERE ([mitarbeiter] = @mitarbeiter )">
        <SelectParameters>
