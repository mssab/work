<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2016_master_intern.master" AutoEventWireup="false" Debug="true" CodeFile="deko_2016_intern_aktion_offen.aspx.vb" Inherits="deko_2016_intern_aktion_offen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT dbo.deko_2016_stammdaten.GP_ID, dbo.deko_2016_stammdaten.name, dbo.deko_2016_stammdaten.strasse, dbo.deko_2016_stammdaten.plz, dbo.deko_2016_stammdaten.ort, dbo.deko_2016_stammdaten.dekoration, dbo.deko_2016_einsaetze.datum, dbo.promotion_login.vorname + ' ' + dbo.promotion_login.nachname AS Mitarbeiter, dbo.deko_2016_stammdaten.freigabe_bericht_extern, dbo.deko_2016_stammdaten.freigabe_bilder_extern, dbo.deko_2016_stammdaten.freigabe_bericht_intern, dbo.deko_2016_stammdaten.freigabe_bilder_intern, dbo.deko_2016_stammdaten.id FROM dbo.deko_2016_stammdaten INNER JOIN dbo.promotion_login ON dbo.deko_2016_stammdaten.mitarbeiter = dbo.promotion_login.id INNER JOIN dbo.deko_2016_einsaetze ON dbo.deko_2016_stammdaten.id = dbo.deko_2016_einsaetze.stammdaten_id WHERE ((dbo.deko_2016_stammdaten.freigabe_bericht_intern = 'Nein' and dbo.deko_2016_stammdaten.freigabe_bericht_extern = 'Ja') OR (dbo.deko_2016_stammdaten.freigabe_bilder_intern = 'Nein' and dbo.deko_2016_stammdaten.freigabe_bilder_extern = 'Ja')) and dbo.promotion_login.projektleiter Like @projektleiter">
        <SelectParameters>
