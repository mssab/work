<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2017_master_intern.master" AutoEventWireup="false" CodeFile="~/deko_2017_intern_projekte_ohne_zuordnung.aspx.vb" Inherits="deko_2017_intern_projekte_ohne_zuordnung" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1>Übersicht über alle Dekorationen ohne zugeordneten Dekorateur</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:promotion %>" 
            ...
            SelectCommand="SELECT GP_ID, name, strasse, plz, ort, dekoration, datum, vl, gvl, glh, id FROM uebersicht_deko_2016 where mitarbeiter = 0">
    </asp:SqlDataSource>
</asp:Content>
