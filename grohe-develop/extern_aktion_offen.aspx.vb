...
Partial Class extern_aktion_offen
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.Cells(6).Text.ToString = "Nein" Then
                If e.Row.Cells(5).Text = "Standard Deko" Then
                    e.Row.Cells(6).Text = "<a href=""extern_eingabe_enjoy.aspx?id=" & e.Row.Cells(8).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
                End If
                If e.Row.Cells(5).Text = "SPA Deko" Then
                    e.Row.Cells(6).Text = "<a href=""extern_eingabe_spa.aspx?id=" & e.Row.Cells(8).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
                End If
            Else
                e.Row.Cells(6).Text = "<img src=""img/16-em-check.png"" alt = ""check"" />"
            End If
            If e.Row.Cells(7).Text.ToString = "Nein" Then
                e.Row.Cells(7).Text = "<a href=""extern_bilder.aspx?id=" & e.Row.Cells(8).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
            Else
