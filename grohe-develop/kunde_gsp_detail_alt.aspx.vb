...
Partial Class kunde_schaufenster_detail
    ...
    Protected Sub nav_fwd_PreRender(sender As Object, e As System.EventArgs) Handles nav_fwd.PreRender
        ...
        con.Open()
        Try
            command = "select max(id) from gsp"
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        con.Open()
        Try
            command = "select count(id) from gsp"
            Dim commando As New SqlCommand(command, con)
            zahl = commando.ExecuteScalar
        ...
        Try
            command = "select kunde from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select name2 from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select CRM_Nummer from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select strasse from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select plz + ' ' + ort as ort from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select telefon from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Dim dummy As String = ""
        Try
            command = "select gsp from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Try
            command = "select glh from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select gvl from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Regalmeter from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Dekodatum from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Eingang_Auftrag from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Status from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Ansprechpartner from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select Mail from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select bemerkungen from gsp where id =" & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        'Try
        '    command = "select freigabe_bilder_intern from gsp where id =" & stamm_id
        '    Dim commando As New SqlCommand(command, con)
        ...
        'End Try
        'Try
        '    command = "select freigabe_bericht_intern from Stammdaten where id =" & stamm_id
        '    Dim commando As New SqlCommand(command, con)
