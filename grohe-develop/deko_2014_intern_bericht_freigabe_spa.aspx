<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2014_master_intern.master" AutoEventWireup="false" CodeFile="deko_2014_intern_bericht_freigabe_spa.aspx.vb" Inherits="deko_2014_intern_bericht_freigabe_spa" %>
    ...
    <table>
        ...
        <Fields>
            ...
            <asp:BoundField DataField="banner_f_digital_deluxe_note" 
                HeaderText="banner_f_digital_deluxe_note" SortExpression="banner_f_digital_deluxe_note" />
            ...
            <asp:BoundField DataField="wuerfel_made_in_germany" 
                HeaderText="deko_cube_spa" SortExpression="wuerfel_made_in_germany" />
            <asp:BoundField DataField="wuerfel_made_in_germany_note" 
                HeaderText="wuerfel_made_in_germany_note" 
            ...
            <asp:BoundField DataField="neue_slideshow_sd_card_note" 
                HeaderText="neue_slideshow_sd_card_note" SortExpression="neue_slideshow_sd_card_note" />
            ...
            <asp:BoundField DataField="aufkleber_grohe_spa_logo_note" 
                HeaderText="aufkleber_grohe_spa_logo_note" SortExpression="aufkleber_grohe_spa_logo_note" />
            ...
            <asp:BoundField DataField="aufkleber_qr_code_note" 
                HeaderText="aufkleber_qr_code_note" SortExpression="aufkleber_qr_code_note" />
            ...
            <asp:BoundField DataField="handtuch_note" HeaderText="handtuch_note" 
            ...
            <asp:BoundField DataField="dig_bilderrahmen_note" HeaderText="dig_bilderrahmen_note" 
            ...
            <asp:BoundField DataField="attraktivitaet_der_fenster" 
                HeaderText="attraktivitaet_der_fenster" SortExpression="attraktivitaet_der_fenster" />
