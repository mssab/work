        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Else
                If e.Row.Cells(10).Text.ToString = "Nein" Then
                    If e.Row.Cells(5).Text = "Standard Deko" Then
                        e.Row.Cells(10).Text = "<a href=""intern_bericht_freigabe_enjoy.aspx?id=" & e.Row.Cells(12).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
                    End If
                    If e.Row.Cells(5).Text = "SPA Deko" Then
                        e.Row.Cells(10).Text = "<a href=""intern_bericht_freigabe_spa.aspx?id=" & e.Row.Cells(12).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
                    End If
            ...
            Else
                If e.Row.Cells(11).Text.ToString = "Nein" Then
                    e.Row.Cells(11).Text = "<a href=""intern_bild_freigabe.aspx?id=" & e.Row.Cells(12).Text.ToString & """><img src=""img/add.png"" alt = ""check"" /></a>"
                Else
