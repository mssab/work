<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2016_master_intern.master" AutoEventWireup="false" CodeFile="deko_2016_intern_ansicht_spa.aspx.vb" Inherits="deko_2016_intern_ansicht_spa" %>
    ...
    <h1>Bericht</h1>
     <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="500px" 
        ...
        <Fields>
            ...
            <asp:BoundField DataField="Banner_Grandera_Note" HeaderText="Banner Grandera_Note" 
            ...
            <asp:BoundField DataField="Dekosäule_Rainshower_Smart" HeaderText="Dekosäule Rainshower Smart" 
