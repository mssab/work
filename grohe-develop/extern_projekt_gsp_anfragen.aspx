<%@ Page Title="" Language="VB" MasterPageFile="~/master_extern_gsp.master" AutoEventWireup="false" CodeFile="extern_projekt_gsp_anfragen.aspx.vb" Inherits="extern_projekt_gsp_alle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h1>Angefragte Dekorationen</h1>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField  HeaderText="Aktion">
                <ItemTemplate>
                    <asp:Button ID="Button1" runat="server" Text="Annehmen" />
                    <asp:Button ID="Button2" runat="server" Text="Ablehnen" />
                </ItemTemplate>
            </asp:TemplateField>
