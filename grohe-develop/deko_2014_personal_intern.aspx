<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2014_master_intern.master" AutoEventWireup="false" CodeFile="deko_2014_personal_intern.aspx.vb" Inherits="deko_2014_personal_intern" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT anmeldename, passwort, projektleiter FROM promotion_login WHERE (id IN (SELECT DISTINCT mitarbeiter FROM deko_2014_stammdaten)) ORDER BY nachname">
    </asp:SqlDataSource>
</asp:Content>
