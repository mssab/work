<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2015_master_extern.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="deko_2015_extern_eingabe_enjoy.aspx.vb" Inherits="deko_2015_extern_eingabe_enjoy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>Eingabe Grohe Standard Deko 2015</h1>
    <table>
        <colgroup>
            <col width="150" />
            <col width="600" />
    ...
    <asp:Panel ID="deko_erfolgt" runat="server">
        ...
        <table style="width: 610px;">
            ...
            <tr>
                <td><b>Banner kubisches Design</b></td>
                <td><asp:TextBox ID="banner_kubisch" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="banner_kubisch_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><b>Banner Armaturen</b></td>
                <td><asp:TextBox ID="banner_armaturen" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="banner_armaturen_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Deko Saeule SML Standard</b></td>
                <td><asp:TextBox ID="deko_saeule_sml" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="deko_saeule_sml_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Vase</b></td>
                <td><asp:TextBox ID="vase" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="vase_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Orchideen</b></td>
                <td><asp:TextBox ID="orchideen" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="orchideen_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Badetuch</b></td>
            ...
            <tr>
                <td><b>Aufkleber Wasser/Splash</b></td>
                <td><asp:TextBox ID="aufkleber_wasser_splash" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="aufkleber_wasser_splash_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><b>Deko Saeule Logo Standard</b></td>
            ...
            <tr>
                <td><b>Mobile Icon Flower</b></td>
                <td><asp:TextBox ID="mobile_icon_flower" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="mobile_icon_flower_note" runat="server"></asp:TextBox></td>
            </tr>
        </table>
        <br />
        <br />
