<%@ Page Title="" Language="VB" MasterPageFile="~/master_kunde.master" AutoEventWireup="false" CodeFile="kunde_gsp_detail.aspx.vb" Inherits="kunde_schaufenster_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="bilder_nicht_vorhanden" runat="server">
        <h2>Für diese ID liegen im Dekoportal leider noch keine Fotos vor.</h2>
    </asp:Panel>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:100%;">
        <tr>
            <td style="width: 50%;">
                ...
                <span style="margin-top:0px; padding-bottom:2px;"><asp:LinkButton ID="LinkButton2" Height="16px"  ForeColor="Black" runat="server">vorherige ID</asp:LinkButton></span>
            </td>
            <td style="width:50%;">
                <span style="margin-top:0px; padding-bottom:2px;"><asp:LinkButton ID="LinkButton1"  Height="16px" ForeColor="Black" runat="server">nächste ID</asp:LinkButton></span>                 
    ...
    <div id="feature_2">
        ...
        <p><b><asp:Label ID="lagerleiter" runat="server"></asp:Label></b></p>
        <p><b><asp:Label ID="telefon" runat="server"></asp:Label></b></p>
        <p><b><asp:Label ID="email" runat="server"></asp:Label></b></p>
        <p><b><asp:Label ID="dekoart" runat="server"></asp:Label></b></p>
        <p><b><asp:Label ID="GVL" runat="server"></asp:Label></b></p>
        <p><b><asp:Label ID="GHL" runat="server"></asp:Label></b></p>
    </div>
    <div id="feature_3">
        <h2>Ergebnis</h2>
        <p><b><asp:Label ID="status" runat="server" ></asp:Label></b></p>
        <p><b><asp:Label ID="Eingangsdatum" runat="server" ></asp:Label></b></p>
        <p><b><asp:Label ID="fertigstelldatum" runat="server" ></asp:Label></b></p>
        <p><b><asp:Label ID="regalmeter" runat="server" ></asp:Label></b></p>
        <p><b><asp:Label ID="regallaenge" runat="server" ></asp:Label></b></p>
        <p><b><asp:Label ID="ergebnis" runat="server" ></asp:Label></b></p>
        <br />
        <h2>Bemerkung</h2>
        <p><b><asp:Label ID="bemerkung" runat="server" ></asp:Label></b></p>
    </div>
</asp:Content>
