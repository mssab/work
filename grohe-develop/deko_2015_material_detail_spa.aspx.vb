...
Partial Class material_detail_spa
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        End Try
        Try
            command = "select count(id) from deko_2015_Stammdaten where dekoration = 'SPA Deko' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2015_Stammdaten where dekoration = 'SPA Deko' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2015_Stammdaten where dekoration = 'SPA Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2015_Stammdaten where dekoration = 'SPA Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Dim derzeitigerbestandarray(15) As Integer
        ...
        For i = 1 To DetailsView1.Rows.Count - 1
            Try
                If derzeitigerbestandarray(i - 1) < 0 Then
                    ...
                    DetailsView3.Rows(i).Cells(1).BackColor = Drawing.Color.Red
                End If
