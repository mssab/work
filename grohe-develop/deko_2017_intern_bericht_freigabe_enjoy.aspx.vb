...
Partial Class deko_2017_intern_bericht_freigabe
    ...
    Protected Sub freigabe_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles freigabe.Click
        ...
        End Try
        Try
            command = "Select freigabe_bilder_extern from deko_2017_stammdaten where id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        If Bild_Extern = "Ja" And Bild_Intern = "Nein" Then
            Response.Redirect("deko_2017_intern_bild_freigabe.aspx?id=" & Request.QueryString.Item("id").ToString)
        Else
    ...
    Protected Sub loeschen_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles loeschen.Click
        ...
        End Try
        Try
            command = "delete from deko_2017_einsatzbericht_enjoy where stammdaten_id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
            commando.ExecuteNonQuery()
