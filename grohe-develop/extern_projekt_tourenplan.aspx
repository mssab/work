<%@ Page Title="" Language="VB" MasterPageFile="~/master_extern.master" AutoEventWireup="true" CodeFile="extern_projekt_tourenplan.aspx.vb" Inherits="extern_projekt_tourenplan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [strasse], [plz], [ort], [telefon], [dekoration] FROM [stammdaten] WHERE((freigabe_bericht_extern = 'nein') and (freigabe_bilder_extern = 'nein')) and ([mitarbeiter] = @mitarbeiter )">
        <SelectParameters>
