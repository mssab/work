...
Partial Class material_detail_standard
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        End Try
        Try
            command = "select count(id) from deko_2016_Stammdaten where dekoration = 'Standard Deko' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2016_Stammdaten where dekoration = 'Standard Deko' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2016_Stammdaten where dekoration = 'Standard Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2016_Stammdaten where dekoration = 'Standard Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
