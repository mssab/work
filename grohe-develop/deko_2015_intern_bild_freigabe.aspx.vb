...
Partial Class deko_2015_intern_bild_freigabe
    ...
    Protected Sub bildanzeige(ByVal bild As String, ByVal part As Image)
        ...
        If IO.File.Exists(Server.MapPath("deko_2015_upload/" & stamm_id & "/" & bild)) Then
            part.ImageUrl = "~/deko_2015_upload/" & stamm_id & "/" & bild
            Dim imageurl As String = Server.MapPath("deko_2015_upload/" & stamm_id & "/" & bild)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        con.Open()
        Try
            command = "update deko_2015_Stammdaten set freigabe_bilder_extern = 'Nein' where id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        con.Open()
        Try
            command = "update deko_2015_Stammdaten set freigabe_bilder_intern = 'Ja' where id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
            commando.ExecuteNonQuery()
