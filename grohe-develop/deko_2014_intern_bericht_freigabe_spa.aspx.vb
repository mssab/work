...
Partial Class deko_2014_intern_bericht_freigabe_spa
    ...
    Protected Sub freigabe_Click(sender As Object, e As System.EventArgs) Handles freigabe.Click
        ...
        con.Open()
        Try
            command = "update deko_2014_stammdaten set freigabe_bericht_intern = 'Ja' where id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        con.Close()
        con.Dispose()
        Response.Redirect("deko_2014_intern_aktion_offen.aspx")
    End Sub
    ...
    Protected Sub loeschen_Click(sender As Object, e As System.EventArgs) Handles loeschen.Click
        ...
        con.Open()
        Try
            command = "update deko_2014_stammdaten set freigabe_bericht_extern = 'Nein' where id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
            commando.ExecuteNonQuery()
        ...
        End Try
        Try
            command = "delete from deko_2014_einsatzbericht_spa where stammdaten_id = " & stamm_id
            Dim commando As New SqlCommand(command, con)
            commando.ExecuteNonQuery()
    ...
    Public Sub bild_labeltext(ByVal bildname As String, ByVal lab As Label)
        Dim stamm_id As String = Request.QueryString.Item("id").ToString
        lab.Text = lab.Text & "<a href=""http://www.grohe.gate-internet.de/deko_2014_upload/" & stamm_id & "/" & bildname & """ target=""_blank"" style=""color:#000;"">Bericht</a><br />"
    End Sub
End Class
