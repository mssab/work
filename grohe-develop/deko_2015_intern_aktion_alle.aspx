<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2015_master_intern.master" AutoEventWireup="false" CodeFile="deko_2015_intern_aktion_alle.aspx.vb" Inherits="deko_2015_intern_aktion_alle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT dbo.deko_2015_stammdaten.GP_ID, dbo.deko_2015_stammdaten.name, dbo.deko_2015_stammdaten.strasse, dbo.deko_2015_stammdaten.plz, dbo.deko_2015_stammdaten.ort, dbo.deko_2015_stammdaten.dekoration, dbo.deko_2015_einsaetze.datum, dbo.promotion_login.vorname + ' ' + dbo.promotion_login.nachname AS Mitarbeiter, dbo.deko_2015_stammdaten.freigabe_bericht_extern, dbo.deko_2015_stammdaten.freigabe_bilder_extern,dbo.deko_2015_stammdaten.freigabe_bericht_intern, dbo.deko_2015_stammdaten.freigabe_bilder_intern, dbo.deko_2015_stammdaten.id FROM dbo.deko_2015_stammdaten INNER JOIN dbo.promotion_login ON dbo.deko_2015_stammdaten.mitarbeiter = dbo.promotion_login.id Left JOIN dbo.deko_2015_einsaetze ON dbo.deko_2015_stammdaten.id = dbo.deko_2015_einsaetze.stammdaten_id where promotion_login.projektleiter like @promo">
        <SelectParameters>
