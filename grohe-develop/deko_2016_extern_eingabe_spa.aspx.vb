...
Partial Class deko_2016_extern_eingabe_spa
    ...
    Public Sub speichern()
        ...
        End Try
        If kontrolle > 0 Then
            command = "update deko_2016_einsatzbericht_spa set zweitanfahrt = 'ja' where stammdaten_id = " & Request.QueryString.Item("id")
            Try
                Dim commando As New SqlCommand(command, con)
    ...
    Public Sub speichern_2(ByVal grund As String)
        ...
        If kontrolle > 0 Then
            'If grund <> "Umbau" Then
            command1 = "update deko_2016_einsatzbericht_spa set zweitanfahrt = 'ja' where stammdaten_id = " & Request.QueryString.Item("id")
            Try
    ...
    Public Sub speichern_3(ByVal grund As String)
        ...
        Dim kontrolle As Integer = 0
        Dim command1 As String = ""
        command1 = "select MAX(id) from deko_2016_vakanz where stammdaten_id = " & Request.QueryString.Item("id")
        Try
            Dim commando As New SqlCommand(command1, con)
            kontrolle = commando.ExecuteScalar
    ...
    Public Sub speichern_vakanz(ByVal grund As String, ByVal dat As String, ByVal adr As String)
        ...
        If erfolg = 1 Then
            ...
            Response.Redirect("deko_2016_extern_vakanz_gespeichert.aspx")
        Else
            keine_deko_moeglich_bemerkung.Text = command
        End If
    End Sub
