<%@ Page Title="" Language="VB" MasterPageFile="~/master_extern.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="extern_eingabe_spa.aspx.vb" Inherits="extern_eingabe_enjoy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="deko_erfolgt" runat="server">
        ...
        <table style="width:600px;">
            ...
            <tr>
                <td><b>Aufkleber Allure Brilliant</b></td>
                <td><asp:TextBox ID="allure" runat="server" CssClass="></asp:TextBox></td>
                <td><asp:TextBox ID="allure_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><b>Banner Power&Soul</b></td>
                <td><asp:TextBox ID="power_and_soul" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="power_and_soul_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Woman</b></td>
                <td><asp:TextBox ID="woman" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="woman_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Grandera</b></td>
                <td><asp:TextBox ID="grandera" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="grandera_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
