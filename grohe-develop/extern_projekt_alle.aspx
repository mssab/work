<%@ Page Title="" Language="VB" MasterPageFile="~/master_extern.master" AutoEventWireup="false" CodeFile="extern_projekt_alle.aspx.vb" Inherits="extern_projekt_alle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [strasse], [plz], [ort], [telefon], [dekoration] FROM [stammdaten] WHERE ([mitarbeiter] = @mitarbeiter )">
        <SelectParameters>
