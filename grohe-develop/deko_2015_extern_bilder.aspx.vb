...
Partial Class deko_2014_extern_bilder_upload
    ...
    Protected Sub upload(ByVal upload As FileUpload, ByVal id As String, ByVal name As String)
        ...
        Else
            If upload.FileContent.Length > 1048576 Then
                filePath = Server.MapPath("deko_2015_upload/" & id & "/" & name)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim Command As String
            Dim id As Integer = 0
            Command = "Update deko_2015_stammdaten set freigabe_bilder_extern = 'Ja' where id = " & Request.QueryString.Item("id").ToString
            Dim con As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("promotion").ConnectionString)
            con.Open()
            Try
                Dim commando As New SqlCommand(Command, con)
    ...
    Public Sub hochladen()
        IO.Directory.CreateDirectory(MapPath("deko_2015_upload/" & Request.QueryString.Item("id").ToString))
