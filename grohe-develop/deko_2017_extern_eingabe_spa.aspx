<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2017_master_extern.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="deko_2017_extern_eingabe_spa.aspx.vb" Inherits="deko_2017_extern_eingabe_spa" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>Eingabe Grohe SPA Deko 2016</h1>
    <table>
        <colgroup>
            <col width="150" />
            <col width="600" />
    ...
    <asp:Panel ID="deko_erfolgt" runat="server">
        ...
        <table style="width: 610px;">
            ...
            <tr>
                <td><b>Banner Rainshower SmartControl</b></td>
                <td><asp:TextBox ID="banner_rainshower_smartcontrol" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="banner_rainshower_smartcontrol_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Banner Spa-Welt</b></td>
                <td><asp:TextBox ID="banner_spa_welt" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="banner_spa_welt_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><b>Banner Sensia Arena</b></td>
                <td><asp:TextBox ID="banner_sensia_arena" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="banner_sensia_arena_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Dekosäule Rainshower Smart</b></td>
                <td><asp:TextBox ID="dekosaele_rainshower_smart" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="dekosaele_rainshower_smart_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Dekowürfel Sensi Arena (Set 3 Stk.)</b></td>
                <td><asp:TextBox ID="dekowuerfel_sensi_arena" runat="server" CssClass="textbox"></asp:TextBox></td>
                <td><asp:TextBox ID="dekowuerfel_sensi_arena_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Deko Würfel Nachhaltigkeit</b></td>
            ...
            <tr>
                <td><b>Mobilee SPA-Welt</b></td>
                <td><asp:TextBox ID="mobilee_spa_welt" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="mobilee_spa_welt_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Dekokörbchen (Set klein/groß)</b></td>
                <td><asp:TextBox ID="dekokoerbchen" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="dekokoerbchen_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="3">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td><b>Handtuch (50x100)</b></td>
                <td><asp:TextBox ID="handtuch_50_100" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="handtuch_50_100_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Handtuch (30x50)</b></td>
                <td><asp:TextBox ID="handtuch_30_50" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="handtuch_30_50_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Bürste</b></td>
            ...
            <tr>
                <td><b>Seife</b></td>
                <td><asp:TextBox ID="seife" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="seife_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td><b>Raumspray</b></td>
                <td><asp:TextBox ID="raumspray" runat="server"></asp:TextBox></td>
                <td><asp:TextBox ID="raumspray_note" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
