...
Partial Class intern_aktion_bestaetigt
    ...
    Protected Sub GridView1_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then         
            ...
            If e.Row.Cells(5).Text = "Standard Deko" Then
                e.Row.Attributes.Add("onclick", "location.href = 'intern_ansicht_standard.aspx?id=" & e.Row.Cells(8).Text & "'")
            End If
            If e.Row.Cells(5).Text = "SPA Deko" Then
                e.Row.Attributes.Add("onclick", "location.href = 'intern_ansicht_spa.aspx?id=" & e.Row.Cells(8).Text & "'")
            End If
