...
Partial Class extern_bilder_upload
    ...
    Protected Sub upload(ByVal upload As FileUpload, ByVal id As String, ByVal name As String)
        ...
        Else
            If upload.FileContent.Length > 1048576 Then
                filePath = Server.MapPath("upload/" & id & "/" & name)
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim Command As String
            Dim id As Integer = 0
            Command = "Update stammdaten set freigabe_bilder_extern = 'Ja' where id = " & Request.QueryString.Item("id").ToString
            Dim con As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("promotion").ConnectionString)
            con.Open()
            Try
                Dim commando As New SqlCommand(Command, con)
    ...
    Public Function upload_check(ByVal upload As FileUpload, meldung As Label) As Integer
        Dim i As Integer = 0
        If upload.HasFile Then
            ...
            Else
                ...
                i = 1
            End If
            'If upload.FileContent.Length > 204800 Then
            '    meldung.Text = "Es dürfen nur Bilder bis 200 KB abgespeichert werden!"
            '    i = 1
            'End If
        End If
        Return i
    ...
    Public Sub hochladen()
        IO.Directory.CreateDirectory(MapPath("upload/" & Request.QueryString.Item("id").ToString))
