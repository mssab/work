<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2016_master_extern.master" AutoEventWireup="true" CodeFile="deko_2016_extern_projekt_alle.aspx.vb" Inherits="deko_2016_extern_projekt_alle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [strasse], [plz], [ort], [telefon], [dekoration] FROM [deko_2016_stammdaten] WHERE ([mitarbeiter] = @mitarbeiter )">
        <SelectParameters>
