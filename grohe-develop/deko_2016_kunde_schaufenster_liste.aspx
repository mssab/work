<%@ Page Title="" Language="VB" MasterPageFile="~/master_kunde.master" AutoEventWireup="false" CodeFile="deko_2016_kunde_schaufenster_liste.aspx.vb" Inherits="kunde_schaufenster_liste" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [plz]+' '+ [ort] as ort, [dekoration], [glh], [id], freigabe_bilder_intern FROM [deko_2016_stammdaten]">
    </asp:SqlDataSource>
</asp:Content>
