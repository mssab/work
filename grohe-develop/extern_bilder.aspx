<%@ Page Title="" Language="VB" Debug="true" MasterPageFile="~/master_extern.master" AutoEventWireup="false" CodeFile="extern_bilder.aspx.vb" Inherits="extern_bilder_upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        <tr>
            ...
            <td><asp:Label ID="meldung_vorher_1" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td>Vorher 2</td>
        ...
        <tr>
            <td>Nachher 4</td>
            <td><asp:FileUpload ID="FileUpload8" runat="server" /></td>
            <td><asp:Label ID="meldung_nachher_4" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td>Bericht</td>
            <td><asp:FileUpload ID="FileUpload9" runat="server" /></td>
