<%@ Page Title="" Language="VB" MasterPageFile="~/deko_2017_master_extern.master" AutoEventWireup="true" CodeFile="deko_2017_extern_projekt_tourenplan.aspx.vb" Inherits="deko_2017_extern_projekt_tourenplan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [GP_ID], [name], [strasse], [plz], [ort], [telefon], [dekoration] FROM [deko_2017_stammdaten] WHERE((freigabe_bericht_extern = 'nein') and (freigabe_bilder_extern = 'nein')) and ([mitarbeiter] = @mitarbeiter )">
        <SelectParameters>
