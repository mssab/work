...
Partial Class material_detail_spa
    ...
    Protected Sub DetailsView1_DataBound(sender As Object, e As System.EventArgs) Handles DetailsView1.DataBound
        DetailsView1.Rows(18).Visible = False
    End Sub
    ...
    Protected Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        End Try
        Try
            command = "select count(id) from deko_2014_Stammdaten where dekoration = 'SPA Deko' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2014_Stammdaten where dekoration = 'SPA Deko' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2014_Stammdaten where dekoration = 'SPA Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        End Try
        Try
            command = "select count(id) from deko_2014_Stammdaten where dekoration = 'SPA Deko' and freigabe_bericht_intern='Ja' and freigabe_bilder_intern = 'Ja' and neu = 'neu' and mitarbeiter = " & stamm_id
            Dim commando As New SqlCommand(command, con)
        ...
        Dim derzeitigerbestandarray(16) As Integer
